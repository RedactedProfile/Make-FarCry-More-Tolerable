...
------------------------------------------------------------------------------------
	...
	EquipmentSounds = {
		...
		--Sound:Load3DSound("SOUNDS/player/playermovement/gingle2.wav",SOUND_UNSCALABLE,50,5,30),
		Sound:Load3DSound("SOUNDS/player/playermovement/gingle3.wav",SOUND_UNSCALABLE,50,5,30),
		--Sound:Load3DSound("SOUNDS/player/playermovement/gingle4.wav",SOUND_UNSCALABLE,50,5,30),
	...
	--StanceChangeSound=Sound:LoadSound("SOUNDS/player/playermovement/stancechange4.wav",SOUND_UNSCALABLE,255),
...
--			System:LogToConsole("ServerAliveState");
...
--		OnTimer = function( self )
	...
	Dead = {
		OnBeginState = function( self )
--			System:LogToConsole("ServerDeadState health "..self.cnt.health);
